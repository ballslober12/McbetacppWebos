...
#ifdef MC_WEBOS
		if (&option == &Options::Option::RENDER_SCALE && !gles2compat::renderScaleAvailable())
			buttons.back()->active = false; // this GPU cannot draw into an offscreen target
#endif
	}
